...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.biometric_auth_flutter.BiometricAuthFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin biometric_auth_flutter, com.example.biometric_auth_flutter.BiometricAuthFlutterPlugin", e);
    }
    try {
